...
```html
<script src="https://cdn.jsdelivr.net/npm/jsonstat-toolkit@1.4.1"></script>
```
...
```html
<script type="module">
import JSONstat from "https://unpkg.com/jsonstat-toolkit@1.4.1/import.mjs";
</script>
```

```html
<script type="module">
import JSONstat from "https://cdn.jsdelivr.net/npm/jsonstat-toolkit@1.4.1/import.mjs";
</script>
```
...
```js
JSONstat = require("jsonstat-toolkit@1.4.1").catch(() => window["JSONstat"])
```
